...
final class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_overridesPreviouslyInsertedCacheValues() {
        ...
        let latestInsertionError = insert((lastFeed, latestTimestamp), to: sut)
        
        XCTAssertNil(latestInsertionError, "Expected to override cache successfully")
        expect(sut, toRetrieve: .found(feed: lastFeed, timestamp: latestTimestamp))
    ...
    func test_delete_emptiesPreviouslyInsertedCache() {
        ...
        let exp = expectation(description: "wait for cache deletion")
        sut.deleteCachedFeed { deleteError in
            XCTAssertNil(deleteError, "Expected non-empty cache deletion to succeed")
            exp.fulfill()
        }
