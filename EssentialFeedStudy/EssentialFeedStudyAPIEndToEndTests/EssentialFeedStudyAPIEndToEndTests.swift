//
//  EssentialFeedStudyAPIEndToEndTests.swift
//  EssentialFeedStudyAPIEndToEndTests
//
//  Created by WEI-TSUNG CHENG on 2023/7/18.
//
...
final class EssentialFeedStudyAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGetFeedResult_matchesFixedTestAccountData() {
        ...
        case let .failure(error):
            XCTFail("Expected successful feed result, not \(error) instead")
        default:
