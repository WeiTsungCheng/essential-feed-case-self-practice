...
//
//  Created by WEI-TSUNG CHENG on 2023/8/20.
//
...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedImageViewLoadingIndicator_isVisibleWhileLoadingImage() {
        ...
        XCTAssertEqual(view0?.isShowingImageLoadingIndicator, true, "Expected image for first view while loading first image")
        XCTAssertEqual(view1?.isShowingImageLoadingIndicator, true, "Expected image for second view while loading second image")
        ...
        XCTAssertEqual(view0?.isShowingImageLoadingIndicator, false, "Expected no loading indicator state change for second view once first image loading complete with error")
